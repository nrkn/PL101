  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_atom() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, numbers) { return Number( numbers.join( '' ) ); })(pos0, result0);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_atomlistelement() {
        var result0, result1;
        var pos0, pos1;
        ...
        if (result0 !== null) {
          result0 = (function(offset, element) { return element; })(pos0, result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_atomlist() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, first, elements) { return [ first ].concat( elements ); })(pos0, result0[0], result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_groupelement() {
        ...
        result0 = parse_group();
        if (result0 !== null) {
          result0 = (function(offset, group) {  return [ group ]; })(pos0, result0);
        }
        if (result0 === null) {
          pos = pos0;
        }
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, atomlist) {  return atomlist; })(pos0, result0[0]);
          }
          if (result0 === null) {
            pos = pos0;
          }
          if (result0 === null) {
            ...
            if (result0 !== null) {
              result0 = (function(offset, quote) {  return [ quote ]; })(pos0, result0[0]);
            }
            if (result0 === null) {
              pos = pos0;
            }
      ...
      function parse_group() {
        ...
        if (result0 !== null) {
          result1 = parse_groupelement();
          if (result1 !== null) {
            result2 = [];
            result3 = parse_groupelement();
            while (result3 !== null) {
              result2.push(result3);
              result3 = parse_groupelement();
            }
